...
export default function SettingsPage() {
  ...
  const [mapStyle, setMapStyle] = useState<MapStylePreset>(() => {
    if (typeof window === "undefined") return "dataviz-dark";
  ...
  const resolvedPrivacy =
    privacy.homePrivacyCenter === null &&
    privacy.homePrivacyRadiusMeters === 200 &&
    privacy.routeVisibility === "private"
        ...
        <Card className="rounded-[2rem] p-5 sm:p-6">
          ...
          <label className="mt-4 block">
            ...
            <input
              ...
              min={50}
              step={25}
              value={resolvedPrivacy.homePrivacyRadiusMeters}
              onChange={(event) =>
                setPrivacy((current) => ({
                  ...current,
          ...
          <label className="mt-3 block">
            ...
            <select
              value={resolvedPrivacy.routeVisibility}
              onChange={(event) =>
                setPrivacy((current) => ({
                  ...current,
